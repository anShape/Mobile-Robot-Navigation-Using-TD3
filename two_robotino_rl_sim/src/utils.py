...
def get_local_goal_waypoints(agent_pose, goal_pose, boundary_radius, epsilon=0.0): #original 0.0
...
def get_laser():
    laser = requests.get('http://192.168.0.1/data/distancesensorarray')

    return laser

def get_cam():
    cam = requests.get('http://192.168.0.1/sensorimage')
