...
def main():
    ...
    state_msg_obs1.pose.position.x, state_msg_obs1.pose.position.y = get_rand_xy()
    ...
    state_msg_obs2.pose.position.x, state_msg_obs1.pose.position.y = get_rand_xy()
    ...
    state_msg_obs3.pose.position.x, state_msg_obs1.pose.position.y = get_rand_xy()
